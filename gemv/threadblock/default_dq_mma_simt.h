...
public:
  ...
  using IteratorB =
      cutlass::transform::threadblock::PredicatedTileIterator<cutlass::MatrixShape<MmaCore::Shape::kK, MmaCore::IteratorThreadMapB::Shape::kStrided>,
                                                              ElementB,
                                                              cutlass::layout::ColumnMajor,
                                                              0,
...
public:
  ...
  using ThreadBlockMma =
      cutlass::gemm::threadblock::DqMmaPipelinedGemv<typename MmaCore::Shape,
                                                       IteratorA,
                                                       IteratorB,
                                                       IteratorScale,
                                                       IteratorZeroPoint,
